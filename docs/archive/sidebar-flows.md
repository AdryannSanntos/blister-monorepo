...
> ⚠️ **ARCHIVED — 2026-06-12**  
> Substituído por [`docs/design-system/blister-os-reference.md`](../design-system/blister-os-reference.md) e NAV do `blister-os-reference.html`.

> Documento de referência de produto legado Workana AI.
