...
export const AttachmentButton = memo(function AttachmentButton({
  ...
  const iconClassName = "w-4 h-4 text-[var(--fg-quaternary)]";
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="size-7 rounded-full flex items-center justify-center hover:bg-[var(--bg-hover)] transition-colors cursor-pointer"
      aria-label="Attach"
    >
      {iconNode}
    </button>
