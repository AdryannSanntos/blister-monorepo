...
- Name: agents-surface.spec.ts >> Agent surface chat layout >> suggestion click fills composer proximity and keeps single input
- Location: e2e/agents-surface.spec.ts:94:7
